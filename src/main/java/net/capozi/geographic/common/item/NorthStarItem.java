...
public class NorthStarItem extends Item {
    private static final int ITEM_BAR_COLOR = MathHelper.packRgb(0.4F, 0.4F, 1.0F);
    private static final int field_51352 = 8;
    public NorthStarItem(Settings settings) {
        super(settings);
    }
    ...
    public boolean onStackClicked(ItemStack stack, Slot slot, ClickType clickType, PlayerEntity player) {
        if (clickType != ClickType.RIGHT) {
            return false;
        } else if (stack.getItem() instanceof CompassItem || stack.getItem() instanceof CalibratedCompassItem) {
